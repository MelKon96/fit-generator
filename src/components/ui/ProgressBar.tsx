...
interface ProgressBarProps {
  ...
  current: number;
  target: number;
  color: string; // Мы будем передавать сюда "bg-orange-500", "bg-yellow-500" и т.д.
}
  ...
  return (
    <div className="space-y-2">
      <div className="flex justify-between items-end">
        ...
        <span className="text-[10px] font-bold text-slate-600">{current} / {target} г ({displayPercentage}%)</span>
      </div>
